...
//Первый случай
/*a = 0.29;//константа, характеризующая степень влияния различных факторов на потери
b = 0.67;//эффективность боевых действий армии у
c = 0.6;//эффективность боевых действий армии х
h = 0.38;//константа, характеризующая степень влияния различных факторов на потери*/
